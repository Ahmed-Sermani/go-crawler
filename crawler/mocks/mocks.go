...
// Source: github.com/Ahmed-Sermani/go-crawler/crawler (interfaces: URLGetter,PrivateNetworkDetector,Graph,Indexer)
...
func (m *MockIndexer) Index(arg0 *indexer.Document) error {
	m.ctrl.T.Helper()
