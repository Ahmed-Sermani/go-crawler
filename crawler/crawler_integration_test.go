...
import (
	...
	"github.com/Ahmed-Sermani/go-crawler/crawler"
	...
	memidx "github.com/Ahmed-Sermani/go-crawler/indexer/store/memory"
...
func (s *CrawlerIntegrationTestSuite) assertLinksIndexed(c *gc.C, g graph.Graph, i indexer.Indexer, links []string, expTitle, expContent string) {
...
func mustCreateBleveIndex(c *gc.C) *memidx.InMemoryIndexer {
