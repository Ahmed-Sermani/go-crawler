...
// Source: github.com/Ahmed-Sermani/go-crawler/service/frontend (interfaces: GraphAPI,IndexAPI)
...
func (m *MockIndexAPI) Search(arg0 indexer.Query) (indexer.Iterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", arg0)
	ret0, _ := ret[0].(indexer.Iterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
